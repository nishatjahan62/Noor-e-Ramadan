...
export default function BookmarkSection({ lang }) {
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  tab === key ? "text-white" : "text-gray-400 bg-gray-100 dark:bg-slate-800 hover:text-primary"
                )}
                style={tab === key ? {
                  background: "linear-gradient(135deg, var(--color-primary), var(--color-secondary))"
                } : {}}
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center gap-3 py-6">
                ...
                <Link
                  ...
                  className={cn("text-xs font-semibold text-primary hover:text-secondary transition-colors", lang === "bn" ? "font-bn" : "font-body")}
                >
