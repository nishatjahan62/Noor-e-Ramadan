      ...
      <div className="mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            >✦</motion.span>
            <p
              className={cn("text-lg tracking-[0.25em] uppercase font-semibold", lang === "bn" ? "font-bn tracking-normal" : "font-heading")}
              style={{
          ...
          <p
            className={cn("text-xs font-semibold italic", lang === "bn" ? "font-bn" : "font-body")}
            style={{
        ...
        <p className={cn("text-sm text-gray-500 dark:text-gray-400 max-w-sm pb-4 text-center lg:text-left", lang === "bn" ? "font-bn" : "font-body")}>
