    ...
    <section className="pt-8 lg:pt-20 px-4">
      <div className="mx-auto max-w-5xl">
        ...
        >
            ...
            <div className="flex gap-2 items-center">
              ...
              <p
                className={cn(
                  ...
                  lang === "bn" ? "font-bn tracking-normal" : "font-heading"
                )}
                style={{
          ...
          {/* Heading + subheading */}
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left gap-1.5 pt-2">
            <h2
            ...
            <p className={cn("text-sm text-gray-500 dark:text-gray-400", lang === "bn" ? "font-bn" : "font-body")}>
